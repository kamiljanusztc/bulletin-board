...
// import {fetchAddPost, fetchEditPost, getPostById, getLoading} from '../../../redux/postsRedux';
...
//   componentDidMount() {
//     if (!this.props.isNewAnnounce && !this.props.postById._id) {
...
//   postById: getPostById(state, props.match.params.id),
//   user: state.user,
